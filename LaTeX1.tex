...
Montrons les formulles avec des outils intuitif. Commençons par le (ii). Si $x$ varie de $\Delta x$ alors on note $\Delta f$ la variation de $f$ entre $x$ et $x+\Delta x$. De même pour $g$ et $f+g$. On a alors : 
\begin{equation*}
\begin{align*}
...
\end{align*}
\end{equation*}
en divisant par $dx$ des deux cotés :
\begin{equation*}
...
\end{align*}
\end{equation*}
Ici il faut comprendre que dans la dérivé, seules les termes <<d'ordre 1>> compte, c'est à dire ceux qui n'ont qu'un seule $d$ au numérateur. Autrement on peut vérifier que Le terme $\frac{\Delta f \Delta g}{\Delta x}$ tend vers 0. On trouve donc finalement : 
\begin{equation*}
